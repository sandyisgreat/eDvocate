...
//    private static final String OUT_DIR = PROJECT_DIR + "/app/src/main/java";
    ...
    private static void addTables(Schema schema) {
        ...
        Entity requestAvailability = addRequestAvailability(schema);
        ...
        Property requestAvailabilityIdForRequestAvailability = requestAvailability.addLongProperty("requestAvailabilityId").notNull().getProperty();
    ...
    private static Entity addRequestAvailability(Schema schema) {
        Entity userDetails = schema.addEntity("AvailabilityTable");
        userDetails.addIdProperty().primaryKey().autoincrement();
        userDetails.addStringProperty("propertyCode");
        userDetails.addStringProperty("");
        userDetails.addStringProperty("lastName");
        userDetails.addDateProperty("birthDate");
        userDetails.addStringProperty("gender");
        userDetails.addStringProperty("country");
        userDetails.addDateProperty("registrationDate");
        return userDetails;
    }
